...
async def create_shooting_session(
    ...
    # 🚀 Najważniejsza poprawka — NIE używamy model_validate (bug SQLModel)
    ss = ShootingSession(**session_data.model_dump())
...
async def update_session(
    ...
    # OK — dane wejściowe to Pydantic, więc dict() jest bezpieczne
    update_data = session_data.model_dump(exclude_unset=True)

    # Aktualizujemy ORM bez użycia .get()
